...
const WORDS = ["Future Network Wizard in the Making", "Curious Mind in Love with Tech!"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind", "Python"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/zEntry6" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/fayadh-muhammad-7905ab233/" },
  { icon: Instagram, link: "https://www.instagram.com/radfxz/?hl=id" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Innovative, functional, and user-friendly websites, built with love and a touch of Fay's magic!
                </p>
