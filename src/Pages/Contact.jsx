  ...
  return (
    <>
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Got something on your mind? Send me a message — I’d love to hear from you and will respond shortly!
        </p>
      </div>
          ...
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                Let’s debug ideas, not just code. Drop me a message and let’s chat!
                </p>
              </div>
            ...
            <form 
              action="https://formsubmit.co/fayadhm04@gmail.com"
              method="POST"
